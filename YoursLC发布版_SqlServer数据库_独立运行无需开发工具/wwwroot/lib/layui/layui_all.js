...
! function(t) {
	...
	var e = t.document,
		...
		l = n.builtin = {
			...
			exTab: "modules/exTab",
			exUtils: "modules/exUtils",
			qrcode: "modules/qrcode",
			exLayer: "modules/exLayer",
			exContextMenu: "modules/exContextMenu",
			exCookie: "modules/exCookie",
			treeGrid: "modules/treeGrid",//加入treeGrid组件
			treeSelect: "modules/treeSelect",//加入treeSelect组件
			multiSelect: "modules/multiSelect",//加入multiSelect组件
