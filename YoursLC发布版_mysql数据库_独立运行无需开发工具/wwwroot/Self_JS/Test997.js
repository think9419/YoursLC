...
layui.define(['jquery', 'table'], function (exports) {
	...
	var api = {
		...
		disabledControls: function (prcno, _fields, _hiddens) {
			...
			//地址
			if (_fields != '#all#' && _fields.indexOf(',inAddress,') == -1) {
				$('#inAddress').attr('disabled','disabled');//禁用
				$('#inAddress').attr('class','layui-input layui-disabled');
				$('#inAddress').removeAttr('lay-verify');//去除校验
				$('#select_inAddress').unbind('click');//解除点击选择
				if (_hiddens.indexOf(';inAddress;') != -1) {
					$('#inAddress').attr('placeholder','******');//保密
					$('#inAddress').val('');
				}
			}
			//测试60
			if (_fields != '#all#' && _fields.indexOf(',inTest60,') == -1) {
				$('#inTest60').attr('disabled','disabled');//禁用
				$('#inTest60').attr('class','layui-input layui-disabled');
				$('#inTest60').removeAttr('lay-verify');//去除校验
				$('#select_inTest60').unbind('click');//解除点击选择
				if (_hiddens.indexOf(';inTest60;') != -1) {
					$('#inTest60').attr('placeholder','******');//保密
					$('#inTest60').val('');
				}
			}
			//测试59
			if (_fields != '#all#' && _fields.indexOf(',inTest59,') == -1) {
				$('#inTest59').attr('disabled','disabled');//禁用
				$('#inTest59').attr('class','layui-input layui-disabled');
				$('#inTest59').removeAttr('lay-verify');//去除校验
				$('#select_inTest59').unbind('click');//解除点击选择
				if (_hiddens.indexOf(';inTest59;') != -1) {
					$('#inTest59').attr('placeholder','******');//保密
					$('#inTest59').val('');
				}
			}
			//测试58
			if (_fields != '#all#' && _fields.indexOf(',inTest58,') == -1) {
				$('#inTest58').attr('disabled','disabled');//禁用
				$('#inTest58').attr('class','layui-input layui-disabled');
				$('#inTest58').removeAttr('lay-verify');//去除校验
				$('#select_inTest58').unbind('click');//解除点击选择
				if (_hiddens.indexOf(';inTest58;') != -1) {
					$('#inTest58').attr('placeholder','******');//保密
					$('#inTest58').val('');
				}
			}
			//测试57
			if (_fields != '#all#' && _fields.indexOf(',inTest57,') == -1) {
				$('#inTest57').attr('disabled','disabled');//禁用
				$('#inTest57').attr('class','layui-input layui-disabled');
				$('#inTest57').removeAttr('lay-verify');//去除校验
				$('#select_inTest57').unbind('click');//解除点击选择
				if (_hiddens.indexOf(';inTest57;') != -1) {
					$('#inTest57').attr('placeholder','******');//保密
					$('#inTest57').val('');
				}
			}
			//测试56
			if (_fields != '#all#' && _fields.indexOf(',inTest56,') == -1) {
				$('#inTest56').attr('disabled','disabled');//禁用
				$('#inTest56').attr('class','layui-input layui-disabled');
				$('#inTest56').removeAttr('lay-verify');//去除校验
				$('#select_inTest56').unbind('click');//解除点击选择
				if (_hiddens.indexOf(';inTest56;') != -1) {
					$('#inTest56').attr('placeholder','******');//保密
					$('#inTest56').val('');
				}
			}
			//测试55
			if (_fields != '#all#' && _fields.indexOf(',inTest55,') == -1) {
				$('#inTest55').attr('disabled','disabled');//禁用
				$('#inTest55').attr('class','layui-input layui-disabled');
				$('#inTest55').removeAttr('lay-verify');//去除校验
				$('#select_inTest55').unbind('click');//解除点击选择
				if (_hiddens.indexOf(';inTest55;') != -1) {
					$('#inTest55').attr('placeholder','******');//保密
					$('#inTest55').val('');
				}
			}
			//测试54
			if (_fields != '#all#' && _fields.indexOf(',inTest54,') == -1) {
				$('#inTest54').attr('disabled','disabled');//禁用
				$('#inTest54').attr('class','layui-input layui-disabled');
				$('#inTest54').removeAttr('lay-verify');//去除校验
				$('#select_inTest54').unbind('click');//解除点击选择
				if (_hiddens.indexOf(';inTest54;') != -1) {
					$('#inTest54').attr('placeholder','******');//保密
					$('#inTest54').val('');
				}
			}
			//测试53
			if (_fields != '#all#' && _fields.indexOf(',inTest53,') == -1) {
				$('#inTest53').attr('disabled','disabled');//禁用
				$('#inTest53').attr('class','layui-input layui-disabled');
				$('#inTest53').removeAttr('lay-verify');//去除校验
				$('#select_inTest53').unbind('click');//解除点击选择
				if (_hiddens.indexOf(';inTest53;') != -1) {
					$('#inTest53').attr('placeholder','******');//保密
					$('#inTest53').val('');
				}
			}
			//测试52
			if (_fields != '#all#' && _fields.indexOf(',inTest52,') == -1) {
				$('#inTest52').attr('disabled','disabled');//禁用
				$('#inTest52').attr('class','layui-input layui-disabled');
				$('#inTest52').removeAttr('lay-verify');//去除校验
				$('#select_inTest52').unbind('click');//解除点击选择
				if (_hiddens.indexOf(';inTest52;') != -1) {
					$('#inTest52').attr('placeholder','******');//保密
					$('#inTest52').val('');
				}
			}
		},
		...
		getControlValueList: function () {
			...
			_list.push({ ControlID: 'inAddress', ControlValue: $('#inAddress').val(), ControlType: '1' });//地址
			_list.push({ ControlID: 'inTest60', ControlValue: $('#inTest60').val(), ControlType: '1' });//测试60
			_list.push({ ControlID: 'inTest59', ControlValue: $('#inTest59').val(), ControlType: '1' });//测试59
			_list.push({ ControlID: 'inTest58', ControlValue: $('#inTest58').val(), ControlType: '1' });//测试58
			_list.push({ ControlID: 'inTest57', ControlValue: $('#inTest57').val(), ControlType: '1' });//测试57
			_list.push({ ControlID: 'inTest56', ControlValue: $('#inTest56').val(), ControlType: '1' });//测试56
			_list.push({ ControlID: 'inTest55', ControlValue: $('#inTest55').val(), ControlType: '1' });//测试55
			_list.push({ ControlID: 'inTest54', ControlValue: $('#inTest54').val(), ControlType: '1' });//测试54
			_list.push({ ControlID: 'inTest53', ControlValue: $('#inTest53').val(), ControlType: '1' });//测试53
			_list.push({ ControlID: 'inTest52', ControlValue: $('#inTest52').val(), ControlType: '1' });//测试52
			return _list;
		},
		...
		getControlValueListFrmParent: function () {
		    var _list = [];
			_list.push({ ControlID: 'listid', ControlValue: $('#_listid').val(), ControlType: '1' });
			_list.push({ ControlID: 'inAddress', ControlValue: $(window.parent.document).find('#inAddress').val(), ControlType: '1' });//地址
			_list.push({ ControlID: 'inTest60', ControlValue: $(window.parent.document).find('#inTest60').val(), ControlType: '1' });//测试60
			_list.push({ ControlID: 'inTest59', ControlValue: $(window.parent.document).find('#inTest59').val(), ControlType: '1' });//测试59
			_list.push({ ControlID: 'inTest58', ControlValue: $(window.parent.document).find('#inTest58').val(), ControlType: '1' });//测试58
			_list.push({ ControlID: 'inTest57', ControlValue: $(window.parent.document).find('#inTest57').val(), ControlType: '1' });//测试57
			_list.push({ ControlID: 'inTest56', ControlValue: $(window.parent.document).find('#inTest56').val(), ControlType: '1' });//测试56
			_list.push({ ControlID: 'inTest55', ControlValue: $(window.parent.document).find('#inTest55').val(), ControlType: '1' });//测试55
			_list.push({ ControlID: 'inTest54', ControlValue: $(window.parent.document).find('#inTest54').val(), ControlType: '1' });//测试54
			_list.push({ ControlID: 'inTest53', ControlValue: $(window.parent.document).find('#inTest53').val(), ControlType: '1' });//测试53
			_list.push({ ControlID: 'inTest52', ControlValue: $(window.parent.document).find('#inTest52').val(), ControlType: '1' });//测试52
			return _list;
		},
