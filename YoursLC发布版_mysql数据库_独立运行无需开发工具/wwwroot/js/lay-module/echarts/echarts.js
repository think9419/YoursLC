! function(t, e) {
		...
		if(h) {
			...
			if(a || !_) {
				...
				var z = function(t, e) {
						...
						if(0 !== n)
							if(T = (e - m[i]) / n, l)
								if(A = y[i], C = y[0 === i ? i : i - 1], D = y[i > h - 2 ? h - 1 : i + 1], k = y[i > h - 3 ? h - 1 : i + 2], f) oi(C, A, D, k, T, T * T, T * T * T, o(t, r), v);
								else {
									var a;
	...
	function en(t, e, i, n, r, a) {
		...
		var L = n.textStrokeWidth,
			...
			R = dn(n.textStroke, L),
			B = fn(n.textFill);
		if(R && (z && (e.lineWidth = L), E && (e.strokeStyle = R)), B && (!s || n.textFill !== o.textFill || o.textBackgroundColor) && (e.fillStyle = B), 1 === f.length) R && e.strokeText(f[0], w, b), B && e.fillText(f[0], w, b);
		else
	...
	function vd(t, e, i, n) {
		...
		function h(i, n) {
			...
			return ba(a, _, null, {
				isRectText: !0
			}, !0), a.text = _.getShallow("show") ? k(t.getFormattedLabel(n, "emphasis"), t.getFormattedLabel(n, "normal"), Uu(e, n)) : null, i && o(a, i), a
		}
	...
	var Wv = function(t) {
		t = t || {}, this.stage = t.stage || {}, this.onframe = t.onframe || function() {}, this._clips = [], this._running = !1, this._time, this._pausedTime, this._pauseStart, this._paused = !1, bg.call(this)
	};
	Wv.prototype = {
		constructor: Wv,
		addClip: function(t) {
	...
	Fr.prototype = {
		...
		brush: function(t, e) {
			...
			if(n.setScale(v[0], v[1]), this.__dirtyPath || f && !g && r ? (n.beginPath(t), f && !g && (n.setLineDash(f), n.setLineDashOffset(p)), this.buildPath(n, this.shape, !1), this.path && (this.__dirtyPath = !1)) : (t.beginPath(), this.path.rebuildPath(t)), a)
	...
	uw._onframe = function() {
		...
		this._model.setOption(t, vw), i ? (this[lw] = {
			silent: n
		}, this[sw] = !1) : (_l(this), cw.update.call(this), this._zr.flush(), this[lw] = !1, this[sw] = !1, Ml.call(this, n), Il.call(this, n))
	...
	o(Wa.prototype, jb), ah({
		...
		_renderNormal: function(t) {
			...
			n.diff(r).add(function(r) {
				...
				h ? La(h, {
					shape: c
				}, s, o) : h = Ub[a.type](n, o, u, c, e, s, !0), n.setItemGraphicEl(o, h), i.add(h), tc(h, n, o, u, c, t, e, "polar" === a.type)
			}).remove(function(t) {
	...
	Bs.extend({
		...
		render: function(t, e, i) {
			...
			f && c.type === n.type && M === this._step ? (m && !p ? p = this._newPolygon(h, _, n, v) : p && !m && (g.remove(p), p = this._polygon = null), g.setClipPath(Jc(n, !1, !1, t)), w && d.updateData(a, {
				...
				t.stopAnimation(!0)
			}), jc(this._stackedOnPoints, _) && jc(this._points, h) || (v ? this._updateAnimation(a, _, n, i, M, y) : (M && (h = td(h, n, M), _ = td(_, n, M)), f.setShape({
				points: h
			}), p && p.setShape({
				points: h,
				stackedOnPoints: _
		...
		_updateAnimation: function(t, e, i, n, r, a) {
			var o = this._polyline,
				...
				d = h.next,
				f = h.stackedOnNext;
			r && (u = td(h.current, i, r), c = td(h.stackedOnCurrent, i, r), d = td(h.next, i, r), f = td(h.stackedOnNext, i, r)), o.shape.__points = h.current, o.shape.points = u, La(o, {
				shape: {
					points: d
				}
			}, l), s && (s.setShape({
	...
	yx.registerSubTypeDefaulter("timeline", function() {
		...
		return i && null != t.currentIndex && (i.setCurrentIndex(t.currentIndex), !i.get("loop", !0) && i.isIndexMax() && i.setPlayState(!1)), e.resetOption("timeline"), s({
