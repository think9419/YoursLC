...
layui.define(['jquery', 'table'], function (exports) {
	...
	var api = {
        ...
        disableListBtn: function (strDisable) {
			...
			if (strDisable == 'all' || strDisable.indexOf('[btn2_Unlock]') > -1) {
				$('#btn2_Unlock').attr('class', 'layui-btn layui-btn-disabled layui-btn-sm');//禁用解锁
				$('#btn2_Unlock').removeAttr('lay-event');
			}
		},
