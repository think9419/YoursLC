...
namespace Think9.Util
{
    public class OperatorProvider
    {
        ...
        /// 缓存操作类
        /// </summary>
        private string cacheKeyOperator = "yourslc_operator_";// +登录者token

        private string cacheKeyToken = "yourslc_token_";// +登录者token
        private string cacheKeyError = "yourslc_error_";// + Mark

        /// <summary>
        /// 秘钥
        /// </summary>
        private string LoginUserToken = "yourslc_Token";

        /// <summary>
        /// 标记登录的浏览器
        /// </summary>
        private string LoginUserMarkKey = "yourslc_Mark";
